# 获取需要扫描的文件夹
# target_folder_list = utils.scan_folder('D:/study/SABRE/', False)

# 循环遍历每个文件夹，调用 process_fid_file 函数处理
# for folder in target_folder_list:
#   utils.process_fid_files(folder, 'D:\Data\Source FID')

# 将 csv 文件转移到 D:\Data\Processed FID 文件夹下
# csv_files = glob.glob('D:\Data\Source FID\*csv')
# for file in csv_files:
#     utils.move_files(file, 'D:\Data\Processed FID')

# 删除 D:\Data\Source FID 文件夹下的所有 csv 文件
# utils.delete_files('D:\Data\Source FID', 'csv')
